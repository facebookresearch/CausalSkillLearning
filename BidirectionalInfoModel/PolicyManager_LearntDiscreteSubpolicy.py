...
class PolicyManager():
	...
	def assemble_inputs(self, input_trajectory, latent_z_indices, latent_b, sample_action_seq):
		...
		subpolicy_inputs[range(len(input_trajectory)),self.input_size+latent_z_indices] = 1.
	...
	def evaluate_loglikelihoods(self, sample_traj, sample_action_seq, concatenated_traj, latent_z_indices, latent_b):
		...
		learnt_subpolicy_loglikelihood = learnt_subpolicy_loglikelihoods.sum()
		...
		return subpolicy_loglikelihoods, subpolicy_loglikelihood, subpolicy_entropy, latent_loglikelihood, \
	...
	def update_policies(self, sample_action_seq, subpolicy_loglikelihoods, subpolicy_entropy, latent_b, latent_z_indices,\
		...
		learnt_subpolicy_loglikelihood, learnt_subpolicy_loglikelihoods, loglikelihood):
