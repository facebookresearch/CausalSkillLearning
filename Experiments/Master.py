...
def parse_arguments():
	...
	parser.add_argument('--reparam',dest='reparam',type=int,default=0)
	# parser.add_argument('--mean_nonlinearity',dest='mean_nonlinearity',type=int,default=1)
	# parser.add_argument('--new_z_selection',dest='new_z_selection',type=int,default=0)
	# parser.add_argument('--state_dependent_z',dest='state_dependent_z',type=int,default=1)
	...
	parser.add_argument('--var_entropy',dest='var_entropy',type=int,default=1)
	...
	parser.add_argument('--subpolicy_clamp_value',dest='subpolicy_clamp_value',type=float,default=-20)
	parser.add_argument('--latent_clamp_value',dest='latent_clamp_value',type=float,default=-5)
	parser.add_argument('--min_variance_bias',dest='min_variance_bias',type=float,default=0.05)
	...
	parser.add_argument('--kl_weight',dest='kl_weight',type=float,default=0.1)
	parser.add_argument('--var_loss_weight',dest='var_loss_weight',type=float,default=0.1)
