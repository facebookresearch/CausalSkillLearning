...
def parse_arguments():
	...
	parser.add_argument('--alternating_phase_size',dest='alternating_phase_size',type=int,default=1, help='Factor by which to scale dataset size to get alternating phase size.')
